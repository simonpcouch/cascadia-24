...
How will these predictions even be used, though? Consider:
...
<!-- First example might prefer R^2, second might prefer MPE, third might prefer some blend of the regressive example and another. -->
