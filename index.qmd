...
<center>github.com/simonpcouch/cascadia-24</center>
...
![](figures/unfairness_1.png){.absolute top="0" left="25" width="750" fig-alt='A screenshot of a webpage from ProPublica. The hero image is composed of a picture of two men, side by side, one black and one white, with the title "Machine bias."'}

. . .

![](figures/chicago.png){.absolute top="60" left="145" width="750" fig-alt='A screenshot of a web article with the title "Predictive policing algorithms are racist. They need to be dismantled."'}

. . .

![](figures/unfairness_3.png){.absolute top="135" left="265" width="750" fig-alt='A screenshot of a web article with the title "Amazon scraps secret AI recruiting engine that showed biases against women."'}
