...
<!-- Borne of these examples is a diverse and active research community, aiming to answer the questions 1) What does it mean for a machine learning system to act fairly? and 2) how can we make systems act more fairly? -->

<br><br><br>
![](figures/scholar_search.png){fig-alt='' style="display: block; margin-left: auto; margin-right: auto; width: 80%; box-shadow: 5px 5px 10px gray;"}

---

<br><br><br>
![](figures/scholar_search_emph.png){fig-alt='' style="display: block; margin-left: auto; margin-right: auto; width: 80%; box-shadow: 5px 5px 10px gray;"}
...
<!-- We run an annual user survey... -->

![](figures/survey_results.png){fig-alt='' style="display: block; margin-left: auto; margin-right: auto; width: 40%; box-shadow: 5px 5px 10px gray;"}
...
* Take some morally held belief about fairness
* Find an evaluation metric that reflects that belief

:::

. . .

The metrics, though, ultimately reflect the belief system that they arose from...
...
The metrics, though, ultimately reflect the belief system that they arose from, and are thus no more compatible than our morally held beliefs of what is fair.
...
<span style="font-size:140%"> ...but there's one more step </span>

. . .

<span style="font-size:300%">**The whole system**</span> 
...
## The whole system: fixed percentage

All properties taxed at .9% assessed value
...
<!-- - maybe MPE... show resulting taxes from the three different approaches -->
<!-- * **Homeowner Exemption**: First xyz not taxed, then .9% assessed value -->
<!-- - maybe different curves for different owners... -->
<!-- * **Transitioning from regressivity**: Is a rapid change in assessment unfair? -->
<!-- - some blend of regressive and R^2 over time -->
<!-- ::: -->
...
<span style="font-size:170%">Choose tools that support thinking about the hard parts.</span> 
